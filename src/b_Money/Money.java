...
// we can use a parametrised Comparable to avoid downcasting issues
public class Money implements Comparable<Money> {
	...
	public Double getAmountFloating() {
		return amount / 100.0;
	}
	...
	public String toString() {
		return String.valueOf(amount/100) + "." + String.format("%02d", amount%100) + " " + getCurrency().getName();
	}
